...
> ### 3D Modeling
> * 종양 경계를 자동으로 감지하거나 수동으로 마킹할 수 있다.
> * 적층된 종양 경계로부터 Point Cloud를 취합하여 종양의 입체 모델을 생성할 수 있다.
> * 종양 모델에 아핀 변환, 사원수 회전 등 변환을 가할 수 있다.
...
> * 종양의 경계를 결정하기 위해 단면 이미지에 Contour detection을 적용하였다.
>   (Meningioma 등 경계가 명확한 종양을 가정하였다.)
 ...
 * **1.03** (2024.12): 종양 경계 auto detection 구현
 ...
 ## Acknowledgments
 * Darcy Mason, Adit Panchal (pydicom: https://github.com/pydicom/pydicom)
